...
/* ═══════════════════════════════════════════════════════════════════════════
 *  PARTE A — Test ya armado (ver README.md, Parte 4)
 * ═══════════════════════════════════════════════════════════════════════════ */
...
void test_carrito_lleno(void) {
    ...
    carrito_agregar(&c, p);  /* 4to producto -> carrito lleno (MAX_ITEMS = 4) */

    int resultado = carrito_agregar(&c, p);  /* 5to intento */
    ASSERT_IGUAL(0, resultado);  /* deberia fallar: carrito ya esta lleno */
}
